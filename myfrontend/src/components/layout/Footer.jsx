            ...
            <div className='container'>
                ...
                <div className='row p-2'>
                    ...
                    <section className='col-12 col-lg-6 d-flex justify-content-center align-items-center'>
                        <p align='justify'>
                            <strong>BookBox</strong> es una página web con un
                            catálogo de libros considerable de diferentes
                            ...
                            nuevos libros disponibles o editar y borrar los
                            libros existentes en el catálogo de acuerdo a la
                            demanda de los mismo.
                        </p>
                        {/* <p>
